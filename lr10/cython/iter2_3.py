# итерация 2-3 
# оптимизация с помощью потоков и процессов и cython
...
if __name__ == "__main__":
    ...
    print(timeit.repeat(stmt="integrate_async_threads(math.sin, 0, math.pi, n_jobs=2, n_iter=100000)", setup="from iter2_3 import integrate_async_threads; import math; from integrate import integrate", repeat=1, number=5))
    
    print("\nПроцессы (n_iter=100000):")
    print(timeit.repeat(stmt="integrate_async_processes(math.sin, 0, math.pi, n_jobs=2, n_iter=100000)", setup="from iter2_3 import integrate_async_processes; import math; from integrate import integrate", repeat=1, number=5))