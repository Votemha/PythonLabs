...
## lr9
В восьмой лабораторной реализовано клиент-сервер CRUD приложение. Основная информация представлена в readme.md в папке lr9.
## lr10
В десятой лабораторной реализована работа с оптимизацией. Результаты измерений записаны в readme.md в папке lr10.